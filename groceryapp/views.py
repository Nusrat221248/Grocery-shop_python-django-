...
def add_product(request):
    ...
    if request.method == "POST":
        ...
        Product.objects.create(name=name, price=price, discount=discount, category=catobj, description=desc,
                               image=image)
...
def edit_product(request, pid):
    ...
    if request.method == "POST":
        ...
        try:
            ...
            pass
        catobj = Category.objects.get(id=cat)
        Product.objects.filter(id=pid).update(name=name, price=price, discount=discount, category=catobj,
                                              description=desc)
